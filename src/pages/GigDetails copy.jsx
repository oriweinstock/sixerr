...
//         let { moveShortReview } = this.state
//         moveShortReview++
//         this.setState({ reviewChoosenIdx, moveShortReview })
//     }
...
//                             <div className="txt flex" style={{ transform: `translateX(${this.state.moveShortReview * 750}px)` }}>
//                                 <ShortReviewList gig={gig} reviews={gig.reviews} reviewChoosenIdx={reviewChoosenIdx} />
//                             </div>
//                             {gig.reviews.length > 1 && <ChevronLeftIcon className="slide-left-review" onClick={() => this.onPrevReview(reviewChoosenIdx)} />}
//                             {gig.reviews.length > 1 && <ChevronRightIcon className="slide-right-review" onClick={() => this.onNextReview(reviewChoosenIdx)} />}
//                         </div>}
//                         <div className="desc">
